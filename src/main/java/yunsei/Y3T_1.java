...
//		PropertyConfigurator.configure("log4j.properties");
		...
		plan = marmot.planBuilder("")
					...
					.store(TEMP_POP)
					.build();
		marmot.deleteDataSet(TEMP_POP);
		result = marmot.createDataSet(TEMP_POP, pop.getGeometryColumn(), pop.getSRID(), plan);
		System.out.println("elapsed: " + watch.getElapsedTimeString());
		...
		marmot.createDataSet(RESULT, pop.getGeometryColumn(), pop.getSRID(), plan);
