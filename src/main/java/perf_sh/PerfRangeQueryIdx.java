 ...
 */
public class PerfRangeQueryIdx {
	private static final String INPUT = "database/layers/perf_sh/cadastral_part/clusters";
//	private static final String INPUT = "perf_sh/cadastral_part/clusters";
	private static final String RESULT = "tmp/perf_sh/range_idx";
	...
	public static final void main(String... args) throws Exception {
		...
		Envelope key = GeoClientUtils.toEnvelope(tl, br);

		Program program = Program.builder()
								.loadSpatialClusterFile(INPUT, SpatialQueryOperation.INTERSECTS, key)
								.store(RESULT)
								.build();
